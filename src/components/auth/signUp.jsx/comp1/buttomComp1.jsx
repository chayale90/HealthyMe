...
export default function ButtomComp1() {
  ...
  return (
    <div>
      <Button onClick={() => nav('/signUp/comp2')} sx={btnStyle} className='loginBtn mt-2'>Next</Button>
      <di style={{ marginTop: "17px", marginBottom: "9px" }} className='d-flex justify-content-center'>
